...
function search() {
    ...
    // Obtenha o div onde deseja realizar a pesquisa
    var div = document.getElementById("pesquisa");
  
    // Obtenha todos os elementos filhos do div
    var elements = div.getElementsByTagName("*");
  
    // Percorra todos os elementos filhos do div
    for (var i = 0; i < elements.length; i++) {
      var element = elements[i];
  
      // Verifique se o texto do elemento corresponde à pesquisa
